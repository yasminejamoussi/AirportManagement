...
import com.example.Airport_Management.reclamation.FeignConfig;
import com.example.Airport_Management.reclamation.PassagerDTO;
import org.springframework.cloud.openfeign.FeignClient;
import org.springframework.web.bind.annotation.GetMapping;
import org.springframework.web.bind.annotation.PathVariable;

@FeignClient(name = "passager-service", url = "${passager.service.url:http://localhost:8091}", configuration = FeignConfig.class)
