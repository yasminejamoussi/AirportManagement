...
public class ForumService {
    ...
    public Forum getForumById(int id) {return forumRepository.findById(id).orElse(null);
    }

    public List<Forum> getForumByCategorie(String categorie) {
        return forumRepository.findByCategorieContainingIgnoreCase(categorie);
    }

    public List<Forum> getAllSortedByCategorieDesc() {
        return forumRepository.findAll(Sort.by(Sort.Direction.DESC, "categorie"));
    }

    public List<Forum> getAllSortedByCategorieAsc() {
        return forumRepository.findAll(Sort.by(Sort.Direction.ASC, "categorie"));
    }
}
